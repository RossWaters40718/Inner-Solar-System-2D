...
import re
# ******* Notes To End User *******
# All Planet Sizes Are Greatly Enlarged But Are Relative To Each Other And The Geocenter
# Positioning Is Correct Except For The Moon. The Moon's Size And Geocenter Positioning
# Has Been Greatly Exaggerated Due To The Enlarged Size Of Earth. The Sun's Size Is Also Incorrect. 
def about():
       msg1='Creator: Ross Waters'
       msg2='\nEmail: RossWatersjr@gmail.com'
       msg3='\nRevision: 1.7'
       msg4='\nLast Revision Date: 04/23/2024'
...
if __name__ == "__main__":
    ...
    top_lbls=[]
    x_rel=[0.085,0.215,0.325,0.44]
    wid=[0.12,0.1,0.105,0.05]
